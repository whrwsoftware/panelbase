...
func (t *template) CentOS7(manager appmanager.Manager) app.Applicable {
	return app.NewApplication(checker, getInstaller(oss.CentOS7), controller, configurator, logger, manager)
}

func (t *template) CentOS8(manager appmanager.Manager) app.Applicable {
	return app.NewApplication(checker, getInstaller(oss.CentOS8), controller, configurator, logger, manager)
}
